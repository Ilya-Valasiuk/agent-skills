---
name: generating-migration
description: Explains the flow for creating database migrations in the project. Use this skill whenever the user wants to update an entity, generate a migration, or asks about the database migration process. It ensures migrations are generated correctly, named clearly, and never run automatically.
---

# Generating Migrations

This skill covers the end-to-end process for creating a TypeORM database migration in this project. Follow these steps in order every time.
...
Do **not** write migration SQL by hand. The migration is generated automatically from entity changes in the next step.
...
| `npm run migration:api:create --name=<name>`   | Create an empty migration file (no diff) |
